...
def show_result(points,
    ...
    if show:
        ...
        vis = Visualizer(points, points_in_box_color=(0, 1, 1))
        ...
        vis1 = Visualizer(points, points_in_box_color=(0, 1, 1))
        if gt_bboxes is not None:
            if gt_labels is None:
                vis1.add_bboxes(bbox3d=gt_bboxes, bbox_color=(0, 0, 1))
            else:
                # palette = Colors()
                palette = [[0, 0, 1], [0.5, 0, 0]]
                labelDict = {}
    ...
    if show:
        ...
        if pred_bboxes is not None:
            ...
            if pred_bboxes.shape[0] == 0:
                ...
                bev_img_show_pred = bev_img.copy()
                # pred_corners = pred_bboxes.corners.numpy()  # (N, 8, 3)
                pred_corners = get_bbox_corners(pred_bboxes)
    ...
    if save:
        ...
        if pred_bboxes is not None:
            ...
            if pred_bboxes.shape[0] == 0:
                ...
                # 4, 2)
                if pred_labels is None:
                    gt_img = draw_bev_boxes(pred_corners_show, gt_img,
                                              color=pred_bbox_color)
                else:
                    palette = Colors()
                    labelDict = {}
...
class Colors:
    ...
    def __init__(self):
        ...
        hex = ('344593', '800000', 'FF3838', 'FFB21D', '48F90A', '00D4BB',
               '6473FF', 'CB38FF', 'FF37C7', '808000')
